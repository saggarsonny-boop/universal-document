  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px' }}>
      ...
      <p style={{ fontSize: 16, color: 'var(--ud-muted)', fontFamily: 'var(--font-body)', marginBottom: 40, lineHeight: 1.6 }}>
        Edit structured metadata on any Universal Document™: title, author, classification (Public / Internal / Confidential / Restricted), audience, jurisdiction, and custom fields. Changes are recorded in provenance.
      </p>
      <div style={{ padding: '48px 32px', background: 'var(--ud-paper-2)', border: '1.5px dashed var(--ud-border-2)', borderRadius: 'var(--ud-radius-xl)', textAlign: 'center' }}>
        ...
        <div style={{ fontFamily: 'var(--font-body)', fontSize: 14, color: 'var(--ud-muted)' }}>UD Metadata Editor is under active development. Free during beta.</div>
      </div>
    </div>
  )
}
