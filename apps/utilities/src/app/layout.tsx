...
import GlobalHiveTracker from '@/components/GlobalHiveTracker'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'UD Utilities — 108 AI-Powered Document Tools. Free Forever.',
    description: '108 document tools: merge, OCR, watermark, sign, translate, summarise, legal bundles, medical forms, and more. No account required.',
