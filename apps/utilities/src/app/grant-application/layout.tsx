...
export const metadata: Metadata = {
  ...
  description: 'Structure any grant application as a tamper-evident .uds with blockchain timestamp proving on-time submission. Supplementary documents bundled as .udz. Free.',
  ...
  openGraph: {
    title: 'UD Grant Application — Tamper-Evident Grant Applications with Submission Proof',
    description: 'Tamper-evident grant applications with blockchain timestamp proving on-time delivery.',
