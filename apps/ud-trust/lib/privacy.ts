...
// phone, street address, "User: <name>" headers. Conservative on names —
// only matches the explicit "User:" / "Name:" prefix to avoid stripping
...
const PATTERNS: Pattern[] = [
  ...
  },
  {
    ...
    regex: /\b(?:User|Name)\s*[:#]?\s*[A-Z][a-z]+(?:\s+[A-Z][a-z]+){1,2}\b/g,
