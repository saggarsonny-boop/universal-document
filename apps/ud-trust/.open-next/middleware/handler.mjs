...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      function k(e2, t2) {
        ...
        let { pathname: r2, query: n2, hash: i2 } = L(e2);
        return "" + t2 + r2 + n2 + i2;
      }
      function j(e2, t2) {
        if (!e2.startsWith("/") || !t2) return e2;
      ...
      class $ {
        constructor(e2, t2, r2) {
          let n2, i2;
          "object" == typeof t2 && "pathname" in t2 || "string" == typeof t2 ? (n2 = t2, i2 = r2 || {}) : i2 = r2 || t2 || {}, this[U] = { url: q(e2, n2 ?? i2.base), options: i2, basePath: "" }, this.analyze();
        }
        analyze() {
          var e2, t2, r2, n2, i2;
        ...
        formatPathname() {
          ...
          }((e2 = { basePath: this[U].basePath, buildId: this[U].buildId, defaultLocale: this[U].options.forceLocale ? void 0 : this[U].defaultLocale, locale: this[U].locale, pathname: this[U].url.pathname, trailingSlash: this[U].trailingSlash }).pathname, e2.locale, e2.buildId ? void 0 : e2.defaultLocale, e2.ignorePrefix), (e2.buildId || !e2.trailingSlash) && (t2 = A(t2)), e2.buildId && (t2 = j(k(t2, "/_next/data/" + e2.buildId), "/" === e2.pathname ? "index.json" : ".json")), t2 = k(t2, e2.basePath), !e2.buildId && e2.trailingSlash ? t2.endsWith("/") ? t2 : j(t2, "/") : A(t2);
        }
        formatSearch() {
      ...
      class F extends Request {
        constructor(e2, t2 = {}) {
          ...
          let n2 = new $(r2, { headers: N(this.headers), nextConfig: t2.nextConfig });
      ...
      class Y extends Response {
        constructor(e2, t2 = {}) {
          ...
          this[W] = { cookies: n2, url: t2.url ? new $(t2.url, { headers: N(r2), nextConfig: t2.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static redirect(e2, t2) {
          ...
          return i2.set("Location", R(e2)), new Y(null, { ...n2, headers: i2, status: r2 });
        }
        static rewrite(e2, t2) {
          let r2 = new Headers(null == t2 ? void 0 : t2.headers);
          return r2.set("x-middleware-rewrite", R(e2)), X(t2, r2), new Y(null, { ...t2, headers: r2 });
        }
        static next(e2) {
      ...
      let ek = { keys: (e2) => Array.from(e2.keys()), get: (e2, t2) => e2.get(t2) ?? void 0 }, ej = (e2, t2) => eR().withPropagatedContext(e2.headers, t2, ek), eD = false;
      async function eV(e2) {
        ...
        let d2 = new eL({ page: e2.page, input: function(e3, t3) {
        ...
        if ((t2 = await ej(d2, () => "/middleware" === e2.page || "/src/middleware" === e2.page ? eR().trace(f.execute, { spanName: `middleware ${d2.method} ${d2.nextUrl.pathname}`, attributes: { "http.target": d2.nextUrl.pathname, "http.method": d2.method } }, () => eM.wrap(eI, { req: d2, renderOpts: { onUpdateCookies: (e3) => {
          n2 = e3;
      ...
      let eq = { matcher: ["/((?!api|_next/static|_next/image|favicon.ico).*)"] }, eU = { ...b }, e$ = eU.middleware || eU.default, eG = "/middleware";
      if ("function" != typeof e$) throw Error(`The Middleware "${eG}" must export a \`middleware\` or a \`default\` function`);
      function eH(e2) {
        return eV({ ...e2, page: eG, handler: e$ });
      }
    }, 945: (e) => {
      "use strict";
